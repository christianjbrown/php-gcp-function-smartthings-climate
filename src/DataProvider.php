...
final class DataProvider implements DataProviderInterface
{
    ...
    private function getTemperatureMeasurementData(DeviceInterface $device): ?DeviceTemperatureInterface
    {
        ...
        // A SmartThings device label is optional; fall back to an empty string when unset.
        $obj = new DeviceTemperature((string) $device->getLabel(), $temperature->getValue(), $timestamp, $stale);

        return $obj;
    }

    private function processDeviceForTemperature(DeviceInterface $device): ?DeviceTemperatureInterface
    {
